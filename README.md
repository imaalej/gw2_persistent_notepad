# GW2 Persistent Notepad

This addon allows you to store notes.
...
- Throw Notepad.dll from releases into GW2/addons/
- compile.sh script is provided to create Notepad.dll from source
